    ...
    return (
        ...
        >
            <div className="logo">
                ...
                <h1 className="logo-title">Ethical Pirates</h1>
            </div>
            <Menu theme="dark" mode="inline" defaultSelectedKeys={['1']}>
                <Menu.Item key="1" icon={<SlidersOutlined />}>
                    <Link to="/home/desirability">Desirability Criteria</Link>
                </Menu.Item>
                <Menu.Item key="2" icon={<StockOutlined />}>
                    <Link to="/home/prediction">Lead Conversion Prediction</Link>
                </Menu.Item>
                <Menu.Item key="3" icon={<BarChartOutlined />}>
                    <Link to="/home/statistics">Lead & Client Statistics</Link>
                </Menu.Item>
                <Menu.Item key="4" icon={<FundOutlined />}>
                    <Link to="/home/firm">Firm Level Prediction</Link>
                </Menu.Item>
                <Menu.SubMenu key="sub1" icon={<ApiOutlined />} title="Testbed">
                    <Menu.Item key="7">
                        <Link to="/home/leadcapture">Lead Capture</Link>
                    </Menu.Item>
                </Menu.SubMenu>
            </Menu>
        </Sider>
